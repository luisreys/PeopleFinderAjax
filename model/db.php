...
function loginDB($username, $password){
  ...
  if ($stmt = $mysqli->prepare("SELECT * FROM servside2017_users WHERE user=? AND pwd=?")) {
    ...
    // Checking if there are any user with this name and password
    if (!$result->num_rows) {
      ...
      //If there are: save the result and return it.
...
/*
* From here there are functions for USER Class methods.
* First: addUser, updateUser and deleteUser
*/
